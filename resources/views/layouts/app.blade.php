...
<body class="antialiased">
    ...
    <nav class="navbar fixed top-0 left-0 right-0 z-50">
        <div class="container-wide">
            <div class="flex justify-between items-center h-20">
                ...
                <a href="{{ url('/') }}" class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-semibold text-gray-900">Instacrente</span>
                </a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="link-subtle">Dashboard</a>
                    @else
        ...
        <!-- Mobile Menu -->
        <div data-mobile-menu class="hidden md:hidden border-t border-gray-200 bg-white">
            <div class="container-wide py-6 space-y-4">
                ...
                <div class="pt-4 border-t border-gray-200 space-y-3">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="block btn-primary text-center">Dashboard</a>
                    @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div class="md:col-span-1">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <span class="text-xl font-semibold">Instacrente</span>
                    </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 border border-gray-700 flex items-center justify-center hover:border-white transition-colors" aria-label="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 border border-gray-700 flex items-center justify-center hover:border-white transition-colors" aria-label="Instagram">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="w-10 h-10 border border-gray-700 flex items-center justify-center hover:border-white transition-colors" aria-label="YouTube">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
